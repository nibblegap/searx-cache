...
class TestUnsplashEngine(TestCase):
    ...
    def test_response(self):
        ...
        self.assertEqual(result[0]['thumbnail_src'], (
            'https://images.unsplash.com/photo-1523557148507-1b77641c7e7c?ixlib=rb-0.3.5&q=80'
